...
【记】：有的人心情不好就喜欢暴饮暴食（mood不好就想吃food）
```
3
```
...
senate ['senɪt] n. 参议院
senior ['siːnɪə] adj. 年长的，高级的（资格较老的）
【记】：
sen = old
（古罗马的）元老院议员  →  议员
```
...
lad [læd] n. 少年，小伙子，家伙
【记】：
1.lad时不努力，老大徒sad（少壮不努力，老大徒伤悲）
2.lad要少玩pad（年轻人要少玩平板）
```
7
```
equip [ɪ'kwɪp] vt. 装备，配备
【记】：
equ = equal, same  →  使具备一些条件让我们不逊色于（equal， same）他人  →  equip
```
8
```
...
【记】：
怕冷（谐音）  →  怕冷的话就看着空调面板上的指数，把温度调高一点  →  面板
```
16
```
